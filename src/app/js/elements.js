...
const newPatientTable = document.querySelector('#new-patient-table');
const newPatientPaginator = document.querySelector('#new-patient-paginator');
const newLength1Input = document.querySelector('#new-m1-length');
const newLength2Input = document.querySelector('#new-m2-length');
const newPlot1 = document.querySelector('#new-m1-plot');
const newPlot2 = document.querySelector('#new-m2-plot');
const newStart1Button = document.querySelector('#start-m1-btn');
const newStart2Button = document.querySelector('#start-m2-btn');
const newResultPatient = document.querySelector('#new-result-patient');
